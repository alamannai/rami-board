    ...
    return (
      <div className="grid grid-cols-3 w-full gap-2 mb-2 ">
        ...
        <div className="self-center">
          <button className="h-8 w-10 mr-4 bg-indigo-400 text-white
          font-bold text-center font-mono rounded-lg shadow-lg   " 
          onClick={subClicked}>
            -
          </button>
          <input type="number" className="text-center font-mono border  w-24 h-8 text-grey-darkest
           rounded-lg" 
                placeholder={vl} onChange={event => setVl(event.target.value)} value={vl}/>
          <button className="h-8 w-10 ml-4 bg-indigo-400 text-white
          font-bold text-center font-mono rounded-lg shadow-lg   " 
          onClick={addClicked}>
            +
          </button>
        ...
        <div className="col-start-3 flex place-content-end h-full ">
          ...
          <p className="self-center text-white font-semibold font-mono">{score}</p>
          </div>
